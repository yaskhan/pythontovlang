...
class TypeInferenceBase(ast.NodeVisitor):
    ...
    def __init__(self):
        # type_map and other metadata maps use composite tuple keys (id, loc) for optimization
        # and string keys for backward compatibility. We use Any for keys/values to satisfy mypy.
        self.type_map: Dict[Any, Any] = {}
        self.raw_type_map: Dict[Any, Any] = {}
        self.mutability_map: Dict[Any, Any] = {}
        self.func_param_mutability: Dict[str, List[int]] = {}
        self.location_map: Dict[Any, str] = {}
        self.call_signatures: Dict[Any, Any] = {}
        ...
        self.explicit_any_types: set[Any] = set()
        self._scope_names = []
