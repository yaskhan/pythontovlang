...
def test_round_two_args():
    # round(3.14159, 2) -> py_round(f64(3.14159), 2)
    assert translate_expr("round(3.14159, 2)") == "py_round(f64(3.14159), 2)"
...
def test_round_with_variables():
    # round(x, n) -> py_round(f64(x), n)
    assert translate_expr("round(x, n)") == "py_round(f64(x), n)"
