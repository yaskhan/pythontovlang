...
"""
    ...
    # New refactored structure uses separate if blocks with match_found flag
    assert "match_found_1" in v_code
    assert "if !match_found_1 && (match_subject_any_1 == 1) {" in v_code
...
"""
    ...
    assert "if !match_found_1 {" in v_code
