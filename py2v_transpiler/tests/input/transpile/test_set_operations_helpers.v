...
fn py_set_union[K](a map[K]bool, b map[K]bool) map[K]bool {
    mut res := a.clone()
    for k, v in b {
        res[k] = v
    }
...
fn py_set_intersection[K](a map[K]bool, b map[K]bool) map[K]bool {
    mut res := map[K]bool{}
    for k, _ in a {
        if k in b {
            res[k] = true
...
fn py_set_difference[K](a map[K]bool, b map[K]bool) map[K]bool {
    mut res := map[K]bool{}
    for k, _ in a {
        if k !in b {
            res[k] = true
...
fn py_set_xor[K](a map[K]bool, b map[K]bool) map[K]bool {
    mut res := map[K]bool{}
    for k, _ in a {
        if k !in b {
            res[k] = true
