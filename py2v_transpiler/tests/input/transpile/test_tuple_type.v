...
pub fn test_tuple_access() {
    ...
    println('t[0]: ${py_subscript(t, 0)}')
    println('t[-1]: ${py_subscript(t, -1)}')
    println('t[1:4]: ${py_slice(t, 1, 4, none)}')
    println('t[::2]: ${py_slice(t, none, none, 2)}')
}
...
pub fn test_tuple_methods() {
    mut t := [1, 2, 3, 2, 4, 2, 5]
    println('Count of 2: ${t.filter(it == 2).len}')
